...
train_dl = data.DataLoader(train_ds, batch_size=BATCH_SIZE, shuffle=True, num_workers=10, pin_memory=True)
...
if __name__ == '__main__':
    myFunction.Train_Tets_Function2(epoch, model, train_dl, loss, optimizer, model_path,
